const KOREA_DIMENSION_ORDER = ['leverage_14d', 'leverage_1d', 'stability', 'investor_deposits', 'leveraged_etf', 'margin', 'kospi', 'kosdaq', 'vkospi', 'liquidation', 'liquidation_ratio'];
